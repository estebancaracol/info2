...
void Jugador::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Jugador::*)();
            if (_t _q_method = &Jugador::enemigoDestruido; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Jugador::*)();
            if (_t _q_method = &Jugador::ladrilloDestruido; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Jugador::*)();
            if (_t _q_method = &Jugador::jugadorMurio; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Jugador::*)();
            if (_t _q_method = &Jugador::bombaColocada; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
