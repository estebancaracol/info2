...
struct qt_meta_stringdata_CLASSEscenaENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSEscenaENDCLASS = QtMocHelpers::stringData(
    "Escena",
    "volverAlMenu",
    "",
    "juegoTerminado",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSEscenaENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Escena::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSEscenaENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSEscenaENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSEscenaENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void Escena::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Escena::*)();
            if (_t _q_method = &Escena::volverAlMenu; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Escena::*)(bool );
            if (_t _q_method = &Escena::juegoTerminado; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *Escena::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSEscenaENDCLASS.stringdata0))
