...
// Diálogo para agregar cuerpos nuevos
...
// NUEVO: Diálogo para editar cuerpos existentes
class DialogoEditarCuerpo : public QDialog
{
    Q_OBJECT
public:
    explicit DialogoEditarCuerpo(CuerpoEstelar* cuerpo, QWidget *parent = nullptr);

    void aplicarCambios();
private slots:
    void seleccionarColor();
private:
    CuerpoEstelar* m_cuerpo;
    QLineEdit* m_lineNombre;
    QDoubleSpinBox* m_spinPosX;
    QDoubleSpinBox* m_spinPosY;
    QDoubleSpinBox* m_spinMasa;
...
private slots:
    ...
    void onToggleColisiones(bool detectar);
    // Actualizaciones de simulación
    void actualizarVisualizacion();
    void actualizarInformacion();
    void onColisionDetectada(const QString& cuerpo1, const QString& cuerpo2);
protected:
...
private:
    ...
    QPushButton* m_botonEditarCuerpo; // NUEVO
    ...
    QCheckBox* m_checkColisiones;
    QPushButton* m_botonResetearZoom;
    ...
    QLabel* m_labelColisiones;
    QLabel* m_labelVerificacion;
    // Simulador
