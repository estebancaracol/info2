...
public:
    ...
    void setMasa(double masa) { m_masa = masa; } // NUEVO: Modificar masa
    void setRadio(double radio) { m_radio = radio; } // NUEVO: Modificar radio
    void setNombre(const QString& nombre) { m_nombre = nombre; } // NUEVO: Modificar nombre
